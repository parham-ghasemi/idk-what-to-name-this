  ...
  return (
    <div className="shopping-cart-steps-container">
      {steps.map((step, index) => (
        <div
          className={`shopping-cart-steps-container__step ${
            index < currentPage && "shopping-cart-steps-container__step--past"
          } ${
            index === currentPage &&
            "shopping-cart-steps-container__step--current"
          } ${
            index > currentPage && "shopping-cart-steps-container__step--future"
          }`}
        >
          <div
            className={`shopping-cart-steps-container__step__circle ${
              index < currentPage &&
              "shopping-cart-steps-container__step__circle--past"
            } ${
              index === currentPage &&
              "shopping-cart-steps-container__step__circle--current"
            } ${
              index > currentPage &&
              "shopping-cart-steps-container__step__circle--future"
            }`}
          >
